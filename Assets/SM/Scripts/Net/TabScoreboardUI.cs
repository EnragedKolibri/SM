// Assets/SM/Scripts/Net/TabScoreboardUI.cs
using UnityEngine;
    ...
    public class TabScoreboardUI : MonoBehaviour
    {
        ...
        private void Refresh()
        {
            ...
            foreach (var kv in fishNet.ClientManager.Clients)
            {
                ...
                row.style.marginBottom = new Length(4);

                var img = new Image();
                img.style.width = 24; img.style.height = 24;
                img.style.marginRight = new Length(8);
                ...
                nameLabel.style.marginRight = new Length(8);

                var pingLabel = new Label($"{ping} ms");
